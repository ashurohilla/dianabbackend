...
class EmployeSerializer(serializers.ModelSerializer):
    ...
    e_gender = serializers.CharField(
        max_length=255,
    )
    e_contact = serializers.CharField(
        max_length=255,
    )
    e_address = serializers.CharField(
        max_length=255,
    )
    ...
    def create(self, validated_data):
        ...
        user = User.objects.create_user(
            username=username, email=email, user_type="employe", password=password
        )
...
class breakstarttimeSerializer(serializers.ModelSerializer):
    class Meta:
        model = breakstarttime
        fields = "__all__"


class breakendtimeSerializer(serializers.ModelSerializer):
    class Meta:
        model = breakendtime
        fields = "__all__"
