...
from api.dashboard.viewset import (
    ...
    meetingViewset,
    DeleteTableViewset,
    DeleteTablescreenshotViewset,
    breakendtimeviewset,
    breakstarttimeviewset,
    NotificationViewset,    
...
router.register(r"deleteactivity", DeleteTableViewset, basename="deletetable")
router.register(r"deletescreenshot", DeleteTablescreenshotViewset, basename="deletescreenshot")
router.register(r"breakstarttime", breakstarttimeviewset, basename="breakstarttime")

router.register(r"breakendtime", breakendtimeviewset, basename="breakendtime")

router.register(r"notification", breakendtimeviewset, basename="notification")
